...
@router.get(
    "/products/{product_id}/specifications", response_model=List[SpecificationResponse]
)
def list_specifications(
    ...
    specs = (
        ...
        .order_by(ProductSpecification.version.desc())
        .all()
    )
...
@router.get(
    "/products/{product_id}/specifications/active", response_model=SpecificationResponse
)
...
@router.get(
    "/products/{product_id}/specifications/{version}",
