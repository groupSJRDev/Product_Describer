...
class Product(Base):
    ...
    references = relationship(
        "ProductReferenceImage", back_populates="product", cascade="all, delete-orphan"
    )
...
class ProductSpecification(Base):
    ...
    primary_dimensions = Column(
        JSONB, nullable=True
    )  # {width: 215.9, height: 260.35, depth: 35.0, unit: "mm"}
    primary_colors = Column(
        JSONB, nullable=True
    )  # [{hex: "#CFE7EE", name: "pale icy blue"}, ...]
