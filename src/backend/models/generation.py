...
class GenerationRequest(Base):
    ...
    specification_id = Column(Integer, ForeignKey("product_specifications.id"), nullable=True)
    ...
    images = relationship("GeneratedImage", back_populates="request", cascade="all, delete-orphan")
